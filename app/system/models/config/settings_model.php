    ...
    'form' => [
        'tabs' => [
            'fields' => [
                ...
                'point_mode' => [
                    'label' => 'lang:system::lang.settings.label_point_mode',
                    'tab' => 'lang:system::lang.settings.text_tab_title_coupon',
                    'type' => 'switch',
                    'default' => FALSE,
                    'comment' => 'lang:system::lang.settings.help_point_mode',
                ],
                'point_value' => [
                    'label' => 'lang:system::lang.settings.label_point_value',
                    'tab' => 'lang:system::lang.settings.text_tab_title_coupon',
                    'type' => 'number',
                    'default' => 0,
                    'comment' => 'lang:system::lang.settings.help_point_value',
                ],
            ],
        ],
        'rules' => [
            ['order_email.*', 'lang:system::lang.settings.label_order_email', 'required|alpha'],
            ['point_mode', 'lang:system::lang.settings.label_point_mode', 'required|integer'],
            ['point_value', 'lang:system::lang.settings.label_point_value', 'required_if:point_mode,1|numeric'],
